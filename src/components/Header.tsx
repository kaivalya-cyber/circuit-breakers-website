      ...
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between h-16 md:h-20">
          <button onClick={() => scrollToSection("hero")} className="flex items-center gap-3 group">
            <div className="relative w-10 h-10">
              <div className="absolute inset-0 rounded-lg bg-gradient-to-br from-cyan-500 to-fuchsia-500 opacity-80 group-hover:opacity-100 transition-opacity animate-pulse-glow" />
          ...
          <button
            ...
            className="hidden lg:flex items-center gap-2 px-5 py-2.5 rounded-lg bg-gradient-to-r from-cyan-500 to-fuchsia-500 hover:from-cyan-400 hover:to-fuchsia-400 text-background font-semibold text-sm transition-all duration-300 hover:shadow-[0_0_30px_hsl(187,100%,50%,0.5)] btn-glow"
          >
            Join The Team
        ...
        <div className={`lg:hidden overflow-hidden transition-all duration-500 ease-in-out ${isMobileOpen ? "max-h-[500px] opacity-100" : "max-h-0 opacity-0"}`}>
          <div className="py-4 space-y-1 border-t border-white/[0.06]">
            ...
            <button
              onClick={() => scrollToSection("contact")}
              className="w-full mt-2 px-4 py-3 rounded-lg bg-gradient-to-r from-cyan-500 to-fuchsia-500 text-background font-semibold text-sm transition-all duration-300"
            >
              Join The Team
            </button>
          </div>
